...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sedan.tiposdeModelos.add(Logan);
        RENAULT.Carroceria.add(sedan);
        RENAULT.Modelos.add(Logan.TipoModelo);
    ...
    public static void registrarVehiculo(){
        ...
        for(Modelo modelo: carroceriaElegida.tiposdeModelos){
            System.out.println(num+") "+modelo.TipoModelo);
        }
        num = 1;
        respuesta = Integer.parseInt(input.nextLine())-1;
        Modelo modeloElegido = carroceriaElegida.tiposdeModelos.get(respuesta);
