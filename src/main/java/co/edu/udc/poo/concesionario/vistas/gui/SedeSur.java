...
public class SedeSur extends JFrame {

    public SedeSur() {
        // Configuración básica de la ventana
        setTitle("CASTAÑO & TOVAR Motor Company - Sede Sur");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new SedeSur().setVisible(true));
    }
}
