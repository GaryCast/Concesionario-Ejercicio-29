...
public class SedeAlta extends JFrame {

    public SedeAlta() {
        // Configuración básica de la ventana
        setTitle("CASTAÑO & TOVAR Motor Company - Sede Alta");
    ...
    private void initComponents() {
        ...
        JLabel tituloSecundario = new JLabel("Sede Alta");
        ...
        // Título de sección
        JLabel tituloAux1 = new JLabel("Opciones de Sede Alta");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new SedeAlta().setVisible(true));
    }
}
