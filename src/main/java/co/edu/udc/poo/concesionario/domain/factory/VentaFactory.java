package co.edu.udc.poo.concesionario.domain.factory;

import co.edu.udc.poo.concesionario.domain.model.Vendedor;
import co.edu.udc.poo.concesionario.domain.model.Venta;
