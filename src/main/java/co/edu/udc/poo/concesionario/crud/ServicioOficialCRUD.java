...
import co.edu.udc.poo.concesionario.domain.model.*;
...
public class ServicioOficialCRUD {
    ...
    public static void agregar(ServicioOficial servicioOficial)throws Exception{
        ...
        for (ServicioOficial servicioOficial1 : listarTodo()) {
            if (servicioOficial1.nif.equals(servicioOficial.nif)) {
                throw new Exception("Servicio oficial ya existe");
            }
        }
        listaServiciosOficiales.add(servicioOficial);
        guardar();
    }

    public static void editar(ServicioOficial servicio) throws Exception {
        for(ServicioOficial office: listarTodo()){
            if(office.nif.equals(servicio.nif)){
                int index = listaServiciosOficiales.indexOf(office);
                ...
                switch (opcion){
                    case "1":
                        ...
                        listaServiciosOficiales.set(index,office);
                        guardar();
                        break;
                    case "2":
        ...
        throw new Exception("ServicioOficial no existe!");
    }

    public static void eliminar(ServicioOficial servicio) throws Exception{
        cargarDatos();
        boolean encontrado = false;
        for(ServicioOficial service: listaServiciosOficiales){
            if(service.nif.equals(servicio.nif)){
                encontrado = true;
                listaServiciosOficiales.remove(service);
                guardar();
        ...
        if(!encontrado){
            throw new Exception("Servicio con nif: "+servicio.nif+" no existe");
        }
    }
    
    public static ServicioOficial buscar(String nif)throws Exception{
        for (ServicioOficial servicioOficial : listarTodo()) {
    ...
    public static ArrayList<ServicioOficial>listarTodo() throws Exception{
        cargarDatos();
        return listaServiciosOficiales;
    }
