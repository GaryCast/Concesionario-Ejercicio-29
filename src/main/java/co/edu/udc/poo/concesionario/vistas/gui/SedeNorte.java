...
public class SedeNorte extends JFrame {

    public SedeNorte() {
        // Configuración básica de la ventana
        Dimension medPantalla = new Dimension(Integer.MAX_VALUE, Integer.MAX_VALUE);
        setTitle("CASTAÑO & TOVAR Motor Company - Sede Norte");
        ...
        JLabel tituloPrincipal = new JLabel("SEDE NORTE");
        tituloPrincipal.setFont(new Font("Tahoma", Font.BOLD, 44));
        tituloPrincipal.setForeground(Color.black);

        JLabel tituloSecundario = new JLabel("Oficina Principal");
        ...
        // Título de sección
        JLabel tituloAux1 = new JLabel("Opciones de Sede");
    ...
    private JButton crearBoton(String texto) {
        JButton boton = new JButton("<html><font color='#0000FF'>" + texto + "</font></html>");
        ...
        boton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                boton.setBackground(new Color(120, 170, 220));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                boton.setBackground(new Color(148, 196, 255));
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            SedeNorte ventana = new SedeNorte();
